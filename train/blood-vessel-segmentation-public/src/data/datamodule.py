...
class DataModule(LightningDataModule):
    def __init__(
        self,
        data_dir: str = "/home/severyn/Desktop/",
        gt_df: str = "/home/severyn/Desktop/Dense-Vascular-Segmentation-in-3D-scans-of-the-human-kidney-with-sparse-annotation/train/blood-vessel-segmentation-public/data",
        fold: int = 0,
        batch_size: int = 8,
        num_workers: int = 0,
